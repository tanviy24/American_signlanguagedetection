...
def Get_frame():
    ...
    while True :
        ...
        print("this is thre - ", skinRegion);
        contours1,_ =cv2.findContours(skinRegion, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
        contours,_= cv2.findContours(thre, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
        print("this is 1- ", contours1);
